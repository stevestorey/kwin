...
void EffectsHandlerImpl::registerTouchscreenSwipeShortcut(SwipeDirection direction, QAction *action)
{
    input()->registerTouchscreenSwipeShortcut(direction, action);
}
